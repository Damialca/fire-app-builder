 ...
 */
public class RBMBasicHttpBasedDataDownloader extends ADataDownloader {
     ...
     * Debug tag.
     */
    private static final String TAG = RBMBasicHttpBasedDataDownloader.class.getSimpleName();
    ...
    /**
     * Constructor for {@link RBMBasicHttpBasedDataDownloader}. It initializes the URL generator using
     ...
     */
    public RBMBasicHttpBasedDataDownloader(Context context) throws ObjectCreatorException,
            DataLoaderException {
     ...
     *
     * @param context The context.
     * @return The {@link RBMBasicHttpBasedDataDownloader} instance.
     * @throws ObjectCreatorException Any exception generated while fetching this instance will be
     *                                wrapped in this exception.
     */
    public static ADataDownloader createInstance(Context context) throws ObjectCreatorException {
        ...
        try {
            return new RBMBasicHttpBasedDataDownloader(context);
        }
    ...
    protected Data fetchData(Recipe dataLoadRecipe) throws AUrlGenerator.UrlGeneratorException,
        ...
        // Get the url.
        List<String> urls = mUrlGenerator.getUrlArray(urlGeneratorRecipeMap);
        return Data.createDataForPayload(NetworkUtils.getDataLocatedAtUrls(urls));
    }
